            ...
            <ul class="flex flex-col lg:flex-row justify-evenly items-center">
                <li class="cursor-pointer capitalize m-4">
                    <button
                        ...
                        class="flex text-center px-4 py-2 hover:bg-accent rounded-md"
                        :class="[
                            selectedSkill === 'all'
                                ? 'bg-accent'
                ...
                >
                    <button
                        ...
                        class="flex text-center px-4 py-2 bg-light-secondary hover:bg-accent text-dark rounded-md"
                        :class="[
                            selectedSkill == projectSkill.id
                                ? 'bg-accent'
                                : 'bg-light-tail-500 dark:bg-dark-navy-100 dark:text-white',
                        ]"
                    >
                        {{ projectSkill.name }}
                    </button>
